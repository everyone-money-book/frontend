...
// const getContents = createAction(GET_POST, (id, contents) => ({id, contents}));
...
// //추가
// export const createContentsAPI = (post) => {
...
const getCalendar = createAction(GET, (id, contents) => ({id, contents}));
const createContents = createAction(CREATE, (contents) => ({ contents }));
const updateContents = createAction(UPDATE, (updateData, contents_index) => ({
  updateData,
  contents_index,
